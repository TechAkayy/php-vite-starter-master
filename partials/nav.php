<header data-pg-name="Default header navigation">
  <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl"><a href="https://flowbite.com"
        class="flex items-center"> <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9"
          alt="Flowbite Logo" /> <span
          class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span> </a>
      <div class="flex items-center lg:order-2"><a href="#"
          class="dark:focus:ring-gray-800 dark:hover:bg-gray-700 dark:text-white focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium hover:bg-gray-50 lg:px-5 lg:py-2.5 mr-2 px-4 py-2 rounded-lg text-gray-800 text-sm">Log
          in</a><a href="#"
          class="bg-primary-700 dark:bg-primary-600 dark:focus:ring-primary-800 dark:hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300 font-medium hover:bg-primary-800 lg:px-5 lg:py-2.5 mr-2 px-4 py-2 rounded-lg text-sm text-white">Get
          started</a>
